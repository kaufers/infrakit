...
func TestHandleOrphansNoPrunes(t *testing.T) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)

	err := tf.handleOrphans(tfFuncs{},
		map[TResourceType]map[TResourceName]TResourceFilenameProps{},
		map[TResourceType]map[TResourceName]struct{}{})
	require.NoError(t, err)
}

func TestHandleOrphansPruneExistingResourceError(t *testing.T) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)
...
func TestHandleOrphansPruneImportError(t *testing.T) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)
...
func TestHandleOrphansRemovedFromBackend(t *testing.T) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)
...
func TestHandleOrphansImportSuccess(t *testing.T) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)
...
func TestHandleFilesPruneMultipleVMTypes_OutOfBand(t *testing.T) {
	_testHandleFilesPruneMultipleVMTypes(t, Prune1RemoveOutOfBand)
}

func TestHandleFilesPruneMultipleVMTypes_ExistsInBackend(t *testing.T) {
	_testHandleFilesPruneMultipleVMTypes(t, Prune2ExistsInBackend)
}

func TestHandleFilesPruneMultipleVMTypes_NoExistsInBackend(t *testing.T) {
	_testHandleFilesPruneMultipleVMTypes(t, Prune3NoExistsInBackend)
}

func _testHandleFilesPruneMultipleVMTypes(t *testing.T, pruneType int) {
	tf, dir := getPlugin(t)
	defer os.RemoveAll(dir)
